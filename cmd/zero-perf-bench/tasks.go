...
func parseTaskArgs(args []string, getenv func(string) string) (taskOptions, error) {
	options := taskOptions{
		Version: strings.TrimSpace(getenv("KEZ_BENCH_VERSION")),
		Commit:  strings.TrimSpace(getenv("KEZ_BENCH_COMMIT")),
	}
...
func taskHelpText() string {
	return strings.Join([]string{
		...
		"  --version <v>       Record the ZERO version (default: $KEZ_BENCH_VERSION)",
		"  --commit <sha>      Record the ZERO commit (default: $KEZ_BENCH_COMMIT)",
