...
import (
	...
	"github.com/abelcondev/kez/internal/release"
)
...
func parseBuildArgs(args []string, getenv func(string) string) (release.BuildOptions, bool, error) {
	options := release.BuildOptions{
		GOOS:   strings.TrimSpace(getenv("KEZ_BUILD_GOOS")),
		GOARCH: strings.TrimSpace(getenv("KEZ_BUILD_GOARCH")),
	}
...
Environment overrides:
  KEZ_BUILD_GOOS, KEZ_BUILD_GOARCH
`)
	return err
}
