...
// containsSkillNamed reports whether a merged skill list contains a skill of the
// given name (used where built-ins make the exact set non-deterministic).
func containsSkillNamed(list []skills.Skill, name string) bool {
