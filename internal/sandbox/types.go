...
// wrapped command carries KEZ_SANDBOXED=1 in its environment. When such a
...
// default.
const EnvSandboxed = "KEZ_SANDBOXED"
...
// ambient flag (a stray or hand-exported KEZ_SANDBOXED=1 with no backend marker
// no longer forces an unsandboxed pass-through).
const EnvSandboxBackend = "KEZ_SANDBOX_BACKEND"
...
// EnvSandboxBackend — so a single user-set/inherited KEZ_SANDBOXED=1 cannot by
