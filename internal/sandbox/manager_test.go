...
func TestPermissionProfileFromPolicyBuildsWorkspaceWriteProfile(t *testing.T) {
	...
	if !stringSliceContains(profile.FileSystem.WriteRoots[0].ProtectedMetadataNames, ".kez") || !stringSliceContains(profile.FileSystem.WriteRoots[0].ProtectedMetadataNames, ".agents") {
