...
func TestIsAlreadySandboxed(t *testing.T) {
	// A lone KEZ_SANDBOXED=1 (no corroborating backend marker) must NOT count as
	...
	// The backend marker alone (no KEZ_SANDBOXED=1) must not count either.
