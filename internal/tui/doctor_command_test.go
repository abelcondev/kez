...
func TestDoctorOptionsIncludeConfigPaths(t *testing.T) {
	m := newModel(context.Background(), Options{
		...
		ProjectConfigPath: "C:/repo/.kez/config.json",
	...
	if options.ProjectConfig != "C:/repo/.kez/config.json" {
		t.Fatalf("ProjectConfig = %q, want %q", options.ProjectConfig, "C:/repo/.kez/config.json")
	}
