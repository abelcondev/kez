...
func TestSpecCommandCreatesDraftReview(t *testing.T) {
	...
	if !strings.Contains(next.pendingSpecReview.RelativePath, ".kez/specs/") {
...
func TestSpecReviewBlocksShiftTabModeCycle(t *testing.T) {
	...
	m.pendingSpecReview = &pendingSpecReviewPrompt{SpecID: "spec", SpecFilePath: ".kez/specs/spec.md"}
