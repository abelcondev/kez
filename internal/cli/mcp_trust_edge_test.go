...
// writeProjectMCPConfig drops a ./.kez/config.json under dir declaring one MCP server,
...
func breakTrustStore(t *testing.T) {
	...
	if err := os.MkdirAll(filepath.Join(configRoot, "kez", "trust.json"), 0o700); err != nil {
		t.Fatal(err)
	}
}
