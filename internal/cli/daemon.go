...
import (
	...
	"github.com/abelcondev/kez/internal/background"
	"github.com/abelcondev/kez/internal/daemon"
	"github.com/abelcondev/kez/internal/daemon/remote"
)
...
Commands:
  ...
  serve-remote --addr <host:port> --tls-cert <f> --tls-key <f> [--bundle-dir <d>]
                            ...
                            daemon. Requires a bearer token in $KEZ_DAEMON_REMOTE_TOKEN
                            (or $KEZ_DAEMON_REMOTE_TOKEN_FILE). --bundle-dir enables
