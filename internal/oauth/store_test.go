...
func TestResolveStorePathHonorsOverride(t *testing.T) {
	...
	path, err := ResolveStorePath(map[string]string{"KEZ_OAUTH_TOKENS_PATH": override})
	if err != nil {
