...
// Override globally with KEZ_STREAM_IDLE_TIMEOUT.
...
// 6 minutes; it still scales with KEZ_STREAM_IDLE_TIMEOUT. A returned value <= 0
...
func ContentStallTimeout(idleTimeout time.Duration) time.Duration {
	...
	// pathologically large KEZ_STREAM_IDLE_TIMEOUT could make idle*6 overflow
...
const streamIdleTimeoutEnv = "KEZ_STREAM_IDLE_TIMEOUT"
...
// KEZ_STREAM_IDLE_TIMEOUT env override if set and valid; otherwise
